var mensData = [
    {
        image_url:
            "https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/107687/03/sv01/fnd/IND/fmt/png/ULTRA-5-MATCH-FG/AG-Unisex-Football-Boots",
    ...
    {
        image_url:
            "https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/107687/03/sv01/fnd/IND/fmt/png/ULTRA-5-MATCH-FG/AG-Unisex-Football-Bootstatic/Product-EX3921/reebok_EX3921_1.jpg.plp",
    ...
    {
        image_url:
            "https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/107687/03/sv01/fnd/IND/fmt/png/ULTRA-5-MATCH-FG/AG-Unisex-Football-Bootshttps://content.shop4reebok.com/static/Product-EW5173/reebok_EW5173_1.jpg.plp",
...
mensData.map(function (mensData) {
    let box = document.createElement("div");
    box.innerHTML = `
        <img src="${elem.image_url}" alt="${elem.name}">
        <p>${elem.name}</p>
        <p><span class="price">₹${elem.price}</span> <span class="striked-price">₹${elem.strikedoffprice}</span></p>
